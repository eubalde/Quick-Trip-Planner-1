...
2. Travel dates are selected using an interactive calendar (maximum 7 days).
3. The user selects up to three interests.
4. The user chooses a preferred travel pace.
5. Voyager generates activity suggestions using AI.
6. A rules-based system validates, filters, and organizes results.
7. A structured, day-by-day itinerary is displayed instantly.
